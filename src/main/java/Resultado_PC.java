...
public class Resultado_PC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lbl_logro_obtenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 27, -1, -1));
        ...
        getContentPane().add(lbl_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 107, -1, -1));

        lbl_pc.setText("pc");
        getContentPane().add(lbl_pc, new org.netbeans.lib.awtextra.AbsoluteConstraints(138, 130, -1, -1));
        ...
        getContentPane().add(BT_volver_a_jugar, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 250, -1, -1));
        ...
        getContentPane().add(BT_Terminar_juego, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 250, -1, -1));
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(16, 153, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon("/Users/axel/Downloads/fotos/juego.jpg")); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 0, 470, 300));
